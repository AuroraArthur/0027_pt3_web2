<div class="container-fluid px-4">
  ...
  <a href="?page=tambah_pelanggan" class="btn btn-primary mb-3">Tambah Data</a>
  <hr>
        ...
        while ($data = mysqli_fetch_array($query)) { 
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="?page=hapus_pelanggan&id=<?php echo $data['id_pelanggan']; ?>" onclick="return confirm('Yakin hapus?')" class="btn btn-danger btn-sm">Hapus</a>
                </td>
            </tr>
        <?php
        $no++;
