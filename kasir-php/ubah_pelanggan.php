...
if (isset($_POST['nama_pelanggan'])) {
    ...
    // proses ubah data
    $query = mysqli_query($koneksi, "UPDATE tb_pelanggan  set nama_pelanggan = '$nama', alamat_pelanggan = '$alamat', no_telp_pelanggan = '$telepon' WHERE id_pelanggan=$id");
    ...
    <form action="" method="post">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <textarea class="form-control" name="alamat" id=""><?php echo $data['alamat_pelanggan'];?></textarea>
                    </td>
                </tr>
                ...
                <tr>
                    <td>No Telepon</td>
                    <td>:</td>
                    <td><input class="form-control" value="<?php echo $data['no_telp_pelanggan'];?>" type="number" stop="0" name="no_telepon"></td>
                </tr>
